...
prompt = 'Introduzca el valor de la longitud del primer eslabon: ';
l1 = input(prompt);
prompt = 'Introduzca el valor de la longitud del segundo eslabon: ';
l2 = input(prompt);
prompt = 'Introduzca el valor de la longitud del tercer eslabon: ';
l3 = input(prompt);

%% Lectura de punto final
prompt = 'Introduzca el valor del punto X: ';
x = input(prompt);
prompt = 'Introduzca el valor del punto Y: ';
y = input(prompt);
prompt = 'Introduzca el valor del punto Z: ';
z = input(prompt);
...
theta3 = atan2 ((sqrt(1-(custheta3)^2)),(custheta3));
